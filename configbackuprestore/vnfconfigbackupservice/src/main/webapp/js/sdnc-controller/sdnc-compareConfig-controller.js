 ...
 * ============LICENSE_END=========================================================
 */
myApp.controller('CompareConfigCtrl', ['$scope', '$http','$window','$filter', 'growl', 'deviceConfigService', 'ObjectDiff', function($scope, $http,$window,$filter, growl, deviceConfigService, ObjectDiff) {
