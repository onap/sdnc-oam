...
USE_MARIA_DB=True # SDNRDB is mariaDB
ROBOT_DEBUG_LEVEL=DEBUG # INFO or DEBUG

ROBOT_VARIABLES="--variablefile=${WORKSPACE}/plans/sdnr/testdata/localhost.py  --variable USE_MARIA_DB:${USE_MARIA_DB} --variable RELEASE_VERSION:${RELEASE_VERSION} -L ${ROBOT_DEBUG_LEVEL}"
