...
openssl req -newkey rsa:4096 -keyform PEM -keyout ca.key -x509 -days 3650 -outform PEM -out ca.crt -noenc \
    -subj "/C=DE/ST=Berlin/L=Berlin/O=ONAP/OU=SDNC/CN=www.onap.org/emailAddress=dev@www.example.com"
openssl genrsa -out client.key 4096
openssl req -new -key client.key -out client.req -noenc \
...
openssl req -new -key server_key.pem -out server.req -sha256 -noenc \
    -subj "/C=PL/ST=DS/L=Wroclaw/O=ONAP/OU=SDNC/CN=www.onap.org"
