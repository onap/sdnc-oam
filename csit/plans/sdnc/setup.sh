...
docker exec ${SDNC_CONTAINER_NAME} ls -l /tmp/gra.patch
docker exec ${SDNC_CONTAINER_NAME} bash -c "/opt/onap/sdnc/svclogic/bin/svclogic.sh install /tmp/gra.patch /opt/onap/sdnc/svclogic/config/svclogic.properties"
