...
#
docker exec sdnc bash -c 'MYSQL_PWD=$MYSQL_PASSWORD MYSQL_DB=$MYSQL_DATABASE /opt/onap/sdnc/svclogic/bin/showActiveGraphs.sh'  | tee $WORKSPACE/archives/active-graphs.txt
