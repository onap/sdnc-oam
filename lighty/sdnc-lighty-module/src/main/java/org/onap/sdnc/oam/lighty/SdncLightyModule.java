...
public class SdncLightyModule extends AbstractLightyModule {
    ...
    protected boolean initProcedure() {
        ...
        this.sdnrWtModule = new SdnrWtModule(dataBroker, rpcProviderRegistry, notificationPublishService,
                mountPointService, clusteringSingletonService);
        if (!CcsdkLightyUtils.startLightyModule(sdnrWtModule)) {
            return false;
        }

        this.oofpcipocModule = new OofpcipocModule(svcLogicService, dataBroker, notificationPublishService,
                rpcProviderRegistry);
    ...
    public SdnrWtModule getSdnrWtModule() {
        return sdnrWtModule;
    }

    public OofpcipocModule getOofpcipocModule() {
        return oofpcipocModule;
    }
}
