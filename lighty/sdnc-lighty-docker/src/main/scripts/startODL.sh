...
exec java -DSDNC_CONFIG_DIR=${SDNC_CONFIG_DIR} -jar opt/lighty/sdnc-lighty-application-1.6.0-SNAPSHOT/sdnc-lighty-application-1.6.0-SNAPSHOT.jar /opt/onap/sdnc/data/properties/lightySdncConfig.json
