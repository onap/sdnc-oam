...
exec java -DSDNC_CONFIG_DIR=${SDNC_CONFIG_DIR} -jar opt/lighty/sdnc-lighty-application-1.6.2-SNAPSHOT/sdnc-lighty-application-1.6.2-SNAPSHOT.jar /opt/onap/sdnc/data/properties/lightySdncConfig.json
